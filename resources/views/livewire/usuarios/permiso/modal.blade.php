...
<div wire:ignore.self class="modal fade" id="crear_permiso" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-hidden="true">
    <div class="modal-dialog modal-ml modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('livewire.usuarios.permiso.form')
            </div>
...
<div wire:ignore.self class="modal fade" id="editar_permiso" tabindex="-1" data-bs-backdrop="static"
...
<div wire:ignore.self class="modal fade" id="borrar_permiso" tabindex="-1" data-bs-backdrop="static"
    data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
