...
<div wire:ignore.self class="modal fade" id="registrar_suscripcion" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-hidden="true">
    <div class="modal-dialog modal-ml modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('livewire.cursos.busqueda.form')
            </div>
...
<div wire:ignore.self class="modal fade" id="editar_curso" tabindex="-1" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-ml modal-dialog-centered ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('livewire.cursos.curso.form')
            </div>
            <div class="modal-footer justify-content-center">
...
<div wire:ignore.self class="modal fade" id="borrar_curso" tabindex="-1" data-bs-backdrop="static"
    data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
