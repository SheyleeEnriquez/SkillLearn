...
<div wire:ignore.self class="modal fade" id="crear_usuario" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-hidden="true">
    <div class="modal-dialog modal-ml modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('livewire.usuarios.usuario.form')
            </div>
            <div class="modal-footer justify-content-center">
                <button type="button" wire:click.prevent="store()" class="btn btn-primary">GUARDAR</button>
                <button type="button" wire:click.prevent="cancel()" class="btn btn-outline-danger"
...
<div wire:ignore.self class="modal fade" id="cambiar_rol" tabindex="-1" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-ml modal-dialog-centered ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('livewire.usuarios.usuario.edit')
            </div>
            <div class="modal-footer justify-content-center">
                <button type="button" wire:click.prevent="cambiarRol()" class="btn btn-actualizar"><span
...
<div wire:ignore.self class="modal fade" id="borrar_usuario" tabindex="-1" data-bs-backdrop="static"
    data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
